    ...
    <div className="min-h-screen bg-black text-white font-mono">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="bg-gray-800 border-3 hover:cursor-text border-white pl-12 pr-5 py-3 focus:border-yellow-400 outline-none w-full md:w-80  text-lg"
                value={searchQuery}
      ...
      <footer className="bg-black border-t-4 border-white py-10 px-4 mt-16 relative z-20">
        <div className="max-w-7xl mx-auto text-center text-gray-500 text-lg">
          &copy; {new Date().getFullYear()} RostraFi. All rights reserved.
        </div>
      </footer>
    </div>
  );
